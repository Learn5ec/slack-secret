...
export async function encryptFile(
  ...
  // Encrypt file bytes with data key
  const ciphertext = sodium.crypto_secretbox_easy(fileBuffer, nonce, dataKey)
...
export async function decryptFile(
  ...
  // Decrypt ciphertext with data key
  const fileBuffer = sodium.crypto_secretbox_open_easy(ciphertext, nonce, dataKey)
